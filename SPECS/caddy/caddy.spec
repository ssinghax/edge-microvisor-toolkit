...
Provides:       bundled(golang(filippo.io/edwards25519)) = 1.2.0
...
Provides:       bundled(golang(github.com/fxamacker/cbor/v2)) = 2.9.0
...
Provides:       bundled(golang(github.com/libdns/libdns)) = 1.1.1
...
Provides:       bundled(golang(github.com/mholt/acmez/v3)) = 3.1.6
# github.com/miekg/dns : BSD-3-Clause
Provides:       bundled(golang(github.com/miekg/dns)) = 1.1.72
...
Provides:       bundled(golang(github.com/smallstep/scep)) = a25cabb
...
Provides:       bundled(golang(github.com/tailscale/tscert)) = aea342f
...
# filippo.io/bigmod : BSD-3-Clause
Provides:       bundled(golang(filippo.io/bigmod)) = 0.1.0
# github.com/ccoveille/go-safecast/v2 : MIT
Provides:       bundled(golang(github.com/ccoveille/go-safecast/v2)) = 2.0.0
# github.com/coreos/go-oidc/v3 : Apache-2.0
Provides:       bundled(golang(github.com/coreos/go-oidc/v3)) = 3.17.0
